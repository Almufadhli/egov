...
<div class="container-fluid text-center" >
 ...
 <img src="<?php echo $picture; ?>" style="background-color: white ; height: 200px; width:200px;">
  ...
  <p>Address: <?php echo $addCity." ".$addPostalCode; ?></p>
  </div>
...
if (isset($wrc)) {
 ...
 ?>
    ...
    <legend>Emergency Contact:</legend>
      <td>   Name: <?php echo $hEC['name']; ?> </td><br><!-- //php select   -->
      <td>   Phone: <?php echo $hEC['phone']; ?></td><br>   <!-- //php select   -->
      <td>   Relationship: <?php echo $hEC['relationship']; ?></td><!-- //php select   -->
    ...
    <legend>General health information:</legend>
       <td> Height: <?php echo $height; ?> cm </td><br><!-- //php select   -->
      <td> Weight: <?php echo $weight; ?> kg </td><br>   <!-- //php select   -->
      <td> BMI: <?php echo $bmi; ?></td><!-- //php select   --> <br>
       <td style="border:1px solid black;"> Blood Type: <?php echo $bloodType; ?></td><!-- //php select   -->
    ...
    <legend>Last Medical Visit:</legend>
      <td> Date: <?php if (isset($desc)) {
        echo $lastDate['date'];
      } ?> </td><br><!-- //php select   -->
      <td> Description: <?php echo $desc; ?> </td><br>   <!-- //php select   -->
      <td> Hospital: <?php echo $hospital; ?></td><!-- //php select   --> <br>
      <td> Diagnosis: <?php echo $diagnosis; ?></td><!-- //php select   --> <br>
    ...
    <legend>Emergency Contact:</legend>
      ...
      <td>   Name: <?php echo $eEC['name']; ?> </td><br><!-- //php select   -->
      <td>   Phone: <?php echo $eEC['phone']; ?></td><br>   <!-- //php select   -->
      <td>   Relationship: <?php echo $eEC['relationship']; ?></td><!-- //php select   -->
  ...
  <fieldset >
    <legend>Last Reports:</legend>
      ...
      <td> Date:<?php if (isset($EduReports)) {
        echo "nothing yet";
      } else {
        echo "none";
      } ?> </td><br><!-- //php select   -->
      <td> From:<?php if (isset($EduReports)) {
        echo "nothing yet";
      } else {
        echo "none";
      } ?></td><br>   <!-- //php select   -->
    ...
    <fieldset >
     <legend>Emergency Contact:</legend>
      ...
      <td>   Name: <?php echo $wEC['name']; ?> </td><br><!-- //php select   -->
      <td>   Phone: <?php echo $wEC['phone']; ?></td><br>   <!-- //php select   -->
      <td>   Relationship: <?php echo $wEC['relationship']; ?></td><!-- //php select   -->
...
<fieldset>
    ...
    <legend>Last Reports:</legend>
      ...
      <td> Date: <?php if (isset($lastDocDate)) {
        echo $lastDocDate['date'];
      } else {
        echo "none";
      }?> </td><br><!-- //php select   -->
      <td> From: <?php if (isset($documents)) {
        echo $documents[0]['uploadedBy'];
      } else {
        echo "none";
      }?></td><br>   <!-- //php select   -->
      <td>Link: <?php if (isset($documents)) {
...
<div id="HEDIV1">
    <table style="border: 1px solid green ;" width="100%">
     ...
     onclick="Emedithelt()">Edit</a> </legend>
      <tr>
       ...
       <tr>
        <td><?php echo $hEC['name']; ?></td><!-- //php select   -->
        <td><?php echo $hEC['phone']; ?></td>   <!-- //php select   -->
        <td><?php echo $hEC['relationship']; ?></td><!-- //php select   -->
      </tr>
      <br>
     </table>
     </div>
  ...
  <div id="HEDIT1"  style="display: none;">
   ...
   <form  method="POST" action="">
     ...
     Emergency Code: <input type="number" name="HRCEmConCode" value="0000" title="Set an emergency code for your record" required>
 ...
 <script>
   ...
   function savehelth(){
      ...
      <div id="HEDIV2">
       ...
       onclick="Emedithelt2()">Edit</a></legend>
       <td> Height: <?php echo $height; ?> cm</td><br><!-- //php select   -->
      <td> Weight: <?php echo $weight; ?> kg</td><br>   <!-- //php select   -->
      <td> BMI: <?php echo $bmi ?></td><!-- //php select   --> <br>
       <td style="border:1px solid black;"> Blood Type: <?php echo $bloodType; ?></td><!-- //php select   -->
...
<div id="EDDIV1">
     ...
     onclick="Emediteud()">Edit</a> </legend>
      <tr>
       ...
       <tr>
        <td><?php echo $eEC['name']; ?></td><!-- //php select   -->
        <td><?php echo $eEC['phone']; ?></td>   <!-- //php select   -->
        <td><?php echo $eEC['relationship']; ?></td><!-- //php select   -->
      </tr>
      <br>
     </table>
     </div>
  ...
  <div id="edit1"  style="display: none;">
   ...
   <form  method="POST" action="">
     Name: <input type="text" name="EDRCEmConName" required><br>
     Phone :<input type="text" name="EDRCEmConPhone" required> <br>
     Relationship: <input type="text" name="EDRCEmConRS" required><br>
     Emergency Code: <input type="number" name="EDRCEmConCode" value="0000" title="Set an emergency code for your record" required>
...
<div id="EDDIV2">
 <table style="border: 1px solid green ;" width="100%">
  ...
  <div id="edit2"  style="display: none;">
    ...
    <form method="POST" action="">
     Current Status: <select name="currentStatus">
...
<!--
<table style="border: 1px solid green ;" width="100%">
 <legend>Highschools attended<a href="#" style="float: right; color: white; font-size:14px " onclick="highscoolediteud()">Edit</a></legend>
 <tr>
 <th >#</th>
 <th>School Name</th>
 <th>Start Date </th>
 ...
 <th>Status </th>
       ...
       <!--           EDIT DIV3            -->
        <div id="edit3"  style="display: none;">
          ...
          <form action="./newSchool.php" method="post" enctype="multipart/form-data">
            School Name: <input type="name" name="schoolName" required> <br>
            Date started: <input type="date" name="dateStarted" required> <br>
            Date ended: <input type="date" name="dateEnded" required><br>
            ...
            Location: <input type="Address" name="location" required><br><br>
            Select file to upload:
            <input type="file" name="fileToUpload" id="fileToUpload"> Types allowed: JPG, JPEG, PNG, PDF, DOC.<br>
  ...
  <!-- ##################################################################################################### -->
      <div id="EDDIV4">
        <!-- <table style="border: 1px solid green ;" width="100%">
        <legend>Universities attended <a href='#' style='float: right; color: white;font-size:14px'
...
<br>
  ...
  <div id="edit4"  style="display: none;">
    ...
    <form action="./newSchool.php" method="post" enctype="multipart/form-data">
        Name:         <input type="text" name="uniName" required> <br>
        Date Started: <input type="date" name="uniFrom" required> <br>
        Date Ended:   <input type="date" name="uniTo" required> <br>
        Degree:       <select name="uniDegree"  required> <br>
                        <option value="Diploma">Diploma</option> <br>
                        <option value="Bachelor">Bachelor</option> <br>
                        <option value="Master">Master</option> <br>
                        <option value="PHD">PHD</option> <br>
                      </select>
        GPA:          <input type="Number" name="uniGPA" max="5" min="0"  required>
        Major:        <input type="text" name="uniMajor"  required>
        Status:      <select  name="uniStatus"  required> <br>
                        <option value="Undergraduate">Undergraduate</option> <br>
                        <option value="Graduate">Graduate</option> <br>
                        <option value="Dropped">Dropped</option> <br>
...
<!--    <img src="..\images\ImgUp\work.jpg" style="width: 100%; height: 200px;">   -->
     ...
     <div  class="col-sm-9"  id="rc" style="width: 50%">
      ...
      <td>   Name: <?php if (isset($wEC['name'])) {
        echo $wEC['name'];
      } else {
        echo "Not set";
      } ?> </td><br><!-- //php select   -->
      <td>   Phone: <?php if (isset($wEC['phone'])) {
        echo $wEC['phone'];
      } else {
        echo "Not set";
      } ?></td><br>   <!-- //php select   -->
      <td>   Relationship: <?php if (isset($wEC['relationship'])) {
       ...
       <form method="post" action="#">                        <!-- edit form work -->
        <fieldset >
       <legend>Edit Emergency Contact: </legend>

       <td>Name:<input type="text" name="WRCEmConName"><br></td>
       <td>Phone: <input type="phone" name="WRCEmConPhone"> <br></td>
       <td>Relationship:<input type="text" name=" WRCEmConRS"><br></td>
       <td>Emergency Code: <input type="number" name="WRCEmConCode" value="0000" title="Set an emergency code for your record" required><br></td>
      </fieldset>
...
<script>
      function Emedit() {
        ...
        <legend>Information</legend>
         <td>Current Status:<?php if (isset($occupation) && $occupation != "") {
           echo "Working";
         } else {
           echo "Not working";
         } ?></td> <!-- //php select   -->
         <br>
         <td>Occupation: <?php if (isset($occupation)) {
           echo $occupation;
         } else {
           echo "-";
         } ?></td>
         <br>
         <td>Employer: <?php if (isset($employerName)) {
           echo $employerName;
         } ?></td>
         <br>
         <td>Field: <?php if (isset($employerField)) {
           echo $employerField;
         } ?></td>
         <br>
         <td>Salary: <?php if (isset($salary)) {
           echo $salary;
         } ?></td>
         <br>
         <td>Office Phone: <?php if (isset($officePhone)) {
           echo $officePhone;
         } ?></td>
...
<script>
 ...
 <div class="col-sm-9"   id="rc9" style="display: none; width: 100%">
         ...
         <form action="./newJob.php" method="post">
           ...
           Employer: <input type="text" name="employer" title="You may enter the company ID" required> <br>
           Start Date: <input type="date" name="startDate" required><br>
           End Date: <input type="date" name="endDate" required><br>
           Reason for leaving: <input type="text" name="reason" required><br>
...
<!-- ***************************************************************************************************** -->
 ...
 //     <td>From</td>
 //     <td>By</td>
 //     <td><img src="./../../resources/images/ImgUp/yes.png" style="width: 30px;height: 30px;"></td>
 //     <td><img src="./../../resources/images/ImgUp/no.png" style="width: 30px;height: 30px;" ></td>
 //     <td><img src="./../../resources/images/ImgUp/block.png" style="width: 30px;height: 30px;"></td>
 // </tr>
 //
 //   </table>
